// -----------------------------------------------------------------------
// <copyright file="AzureOpenaiAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.AzureOpenai;

/// <summary>
/// AzureOpenai adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class AzureOpenaiAdapter
{
    private readonly AzureOpenaiOptions _options;
    private readonly ILogger<AzureOpenaiAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="AzureOpenaiAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public AzureOpenaiAdapter(IOptions<AzureOpenaiOptions> options, ILogger<AzureOpenaiAdapter> logger)
    {
